...
<input type="text" class="form-control" id="username" placeholder="Masukkan Username Anda" autocomplete="off" required name="username">
</div>
<div class="form-group">
...
<option value="">Silahkan pilih role akses</option>
